...
- Удалить слитую feature-ветку (если больше не нужна)
- Убедиться, что связанные issues закрыты/сосланы
- Проверить, что CI на base-ветке зелёный
- Решить, нужен ли релиз/тег и зафиксировать повышение версии
